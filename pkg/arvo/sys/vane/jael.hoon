  ...
  ++  call                                              ::  invoke
    ...
    ::
      ...
      =.  pos.zim.pki
        ...
        %+  ~(put by pos.zim.pki)
          our
        [0 lyf.seed.tac (malt [lyf.seed.tac [1 pub:ex:cub]] ~) spon-ship]
      ::  our initial private key
      ::
      =.  lyf.own.pki  lyf.seed.tac
      =.  jaw.own.pki  (malt [lyf.seed.tac key.seed.tac] ~)
    ...
    ::
      ...
      =.  pos.zim.pki
        %+  ~(put by pos.zim.pki)
          our
        [rift=0 life=1 (malt [`@ud`1 [`life`1 pub:ex:cub]] ~) `(^sein:title our)]
      ::  our private key
      ::
    ...
    ++  fake
      ...
      ++  public-keys
        ...
        =/  points=(list (pair ship point))
          ...
          |=  [who=ship =pass]
          ^-  [who=ship =point]
          [who [rift=0 life=1 (malt [1 1 pass] ~) `(^sein:title who)]]
        =.  moz  [[hen %give %public-keys %full (malt points)] moz]
        ..feel
      --
    --
  ::
